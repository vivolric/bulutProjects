...
//    }
    ...
    public Book() {  //default constructor (dynamic)
    ...
    add method named **hasThreePrices ** which will check if book has all three
    (Leather Bound, Hardcover, Audible Audiobook) prices in it
     */
