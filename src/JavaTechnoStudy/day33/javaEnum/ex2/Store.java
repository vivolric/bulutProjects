...
public class Store {
    ...
    //12:05
    public void printFantasyBooks() {      // public void method
        ArrayList<Book> books = getBooks();

        for (Book book : books) {
//            if(book.getBookCategory() == BookCategory.FANTASY) {   ===> you need to create a public method
//                System.out.println(book);                              inside of Book class to able to get Fantasy Book
//            }
