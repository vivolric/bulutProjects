...
public class Task1 {
    ...
    public static ArrayList<Integer> createArraylist() {  // 0 parameter
        ...
        //the main diff btwn Array and Arraylist, Array accepts only primitive data and object
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Integer> myNewList = createArraylist(24); // 24 olarak sinirlandirinca oraya kadar aldi konsol

        ArrayList<Integer> myNewList2 = createArraylist(1, 3, 67, 78, 4); // burda sadece cift sayilari yazar
